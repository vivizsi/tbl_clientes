...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.codigo, p.nombre_completo, p.telefono, p.correo, p.codigo_postal, p.numero_cuenta
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->nombre_completo. "<br>" .$producto->codigo_postal. "<br>"  . $producto->numero_cuenta . "<br>" . $producto->telefono;  ?> <strong>$<?php echo number_format($producto->precioVenta, 2) ?></strong></td>
